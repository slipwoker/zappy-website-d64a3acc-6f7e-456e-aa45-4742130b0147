    ...
    if (contactForm) {
        ...
        function validateInput(input) {
            ...
            if (input.value.trim() && input.type === 'tel') {
                if (!validationRules.tel.pattern.test(input.value)) {
                    showError(input, validationRules.tel.message);
                    return false;
                }
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd64a3acc-6f7e-456e-aa45-4742130b0147',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd64a3acc-6f7e-456e-aa45-4742130b0147';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd64a3acc-6f7e-456e-aa45-4742130b0147';
